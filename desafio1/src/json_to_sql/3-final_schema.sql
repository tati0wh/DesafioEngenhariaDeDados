...
-- 2. Adição de chaves primárias, estrangeiras e índices para otimizar consultas.
-- 3. Implementação de restrições de integridade.
-- 4. Ajustes nos tipos de dados e precisão das colunas conforme necessário.
-- 5. Foram adicionados as instâncias citadas no enunciado.
